...
import { HtmlReporterOptions, Metrics, SuiteInfo, TestInfo } from "./types";
export default class HtmlReporter extends WDIOReporter {
    ...
    pushTest(test: TestInfo): void;
    moveErrorsToEvents(test: TestInfo): void;
